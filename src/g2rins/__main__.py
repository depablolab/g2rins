...
def _print_license(args):
    ...
    license_text += "Copyright (C) 2025 Gervasio Zaldivar, Yuan Tian\n"
...
SHORT_LICENSE_TEXT = "G2RINS  Copyright (C) 2025  Gervasio Zaldivar, Yuan Tian\n\n"
...
def main(argv):
    ...
    main_parser = argparse.ArgumentParser(
        description="G2RINS -- generation of molecular ensembles from a G2RINS string.",
        prog="g2rins",
    )
    main_parser.add_argument("--version", "-v", action="version", version="%(prog)s " + g2rins.__version__)
